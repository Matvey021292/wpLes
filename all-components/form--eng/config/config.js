...
"inputs-template" : {
  "firstname" : "<div class='form_group--name'> <input data-validation-type='firstname' name='firstname' placeholder='Name' required><div class='validation'><i class='fa fa-exclamation'></i></div> <div class='error'></div></div>",
  "lastname" : "<div class='form_group--name'> <input data-validation-type='lastname' placeholder='Lastname' name='lastname' value='' required><div class='validation'><i class='fa fa-exclamation'></i></div> <div class='error'></div></div>",
  ...
  "conditions" : "<div class='checkbox-wrapper'> <label><input  class='inverted' required name='conditions' type='checkbox' data-validation-type='conditions'> I agree with <a href='/terms'>Customer Agreement</a></label><div class='validation'><i class='fa fa-exclamation'></i></div> <div class='error'></div></div>",
  "age" : "<div class='checkbox-wrapper'> <label><input  class='inverted' required name='age' type='checkbox' data-validation-type='age'> I am more than 18 years</label><div class='validation'><i class='fa fa-exclamation'></i></div> <div class='error'></div></div>",
...
var formsList = ['https://moneytrack.pro/en/form.js', 'js/form.js'];
